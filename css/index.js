...

{
    ...
    let containers=document.querySelectorAll(".supermarket");//引入div标签container
    tips.forEach(function(ele,index){//列出tips的元素
        ele.onclick=function(){//鼠标单击效果
            let ot=containers[index].offsetTop;//当前对象到上级层左边的距离减去50像素
    ...
    window.addEventListener("scroll",function(){
        ...
        for(let i=0;i<containers.length;i++){
            if(st>containers[i].offsetTop-1000){
